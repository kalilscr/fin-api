...
describe("Create Statement Controller", () => {
  ...
  it("Should /POST /api/v1/statements/deposit to create a statement of type deposit", async () => {
  ...
  it("Should /POST /api/v1/statements/withdraw to create a statement of type withdraw", async () => {
    const authenticationResponse = await request(app)
      .post("/api/v1/sessions")
      .send({
        email: mocked_user.email,
  ...
  it("Should /POST /api/v1/statements/deposit and not be able to create a statement to non authenticated user", async () => {
    const statementResponse = await request(app)
      .post("/api/v1/statements/deposit")
      .send({
        amount: 1000,
    ...
    expect(statementResponse.body).toStrictEqual({
